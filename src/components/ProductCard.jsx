            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-indigo-500">
                        {count === 0 ? (
                            <button className="flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-20px w-[64px] h-[34px] rounded text-indigo-600 font-medium" onClick={() => setCount(1)} >
